...
/****************************************************** Globals ****************************************************************************/
static const char *verSalt = "Uj_y6L*-mhc@77d"; // Value will be passed by python tool
static const char *decryptSalt = "FAK@$P[';wea!e2"; // Value will be passed by python tool
